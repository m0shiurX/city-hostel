...
class MessengerController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.messenger.index', compact('topics', 'title', 'unreads'));
    }
    ...
    public function createTopic()
    {
        ...
        return view('frontend.messenger.create', compact('users', 'unreads'));
    }
    ...
    public function storeTopic(QaTopicCreateRequest $request)
    {
        ...
        return redirect()->route('frontend.messenger.index');
    }
    ...
    public function showMessages(QaTopic $topic)
    {
        ...
        return view('frontend.messenger.show', compact('topic', 'unreads'));
    }
    ...
    public function showReply(QaTopic $topic)
    {
        ...
        return view('frontend.messenger.reply', compact('topic', 'unreads'));
    }
