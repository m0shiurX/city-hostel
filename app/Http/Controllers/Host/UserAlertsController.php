...
class UserAlertsController extends Controller
{
    public function index()
    {
        ...
        return view('host.userAlerts.index', compact('userAlerts'));
    }
    ...
    public function create()
    {
        ...
        return view('host.userAlerts.create', compact('users'));
    }
    ...
    public function store(StoreUserAlertRequest $request)
    {
        ...
        return redirect()->route('host.user-alerts.index');
    }
    ...
    public function show(UserAlert $userAlert)
    {
        ...
        return view('host.userAlerts.show', compact('userAlert'));
    }
