...
class HostelController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('host.hostels.index', compact('hostels'));
    }
    ...
    public function create()
    {
        ...
        return view('host.hostels.create', compact('areas', 'categories', 'facilities'));
    }
    ...
    public function store(StoreHostelRequest $request)
    {
        ...
        return redirect()->route('host.hostels.index');
    }
    ...
    public function edit(Hostel $hostel)
    {
        ...
        return view('host.hostels.edit', compact('areas', 'categories', 'facilities', 'hostel'));
    }
    ...
    public function show(Hostel $hostel)
    {
        ...
        return view('host.hostels.show', compact('hostel'));
    }
