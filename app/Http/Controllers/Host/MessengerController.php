...
class MessengerController extends Controller
{
    public function index()
    {
        ...
        return view('host.messenger.index', compact('topics', 'title', 'unreads'));
    }
    ...
    public function createTopic()
    {
        ...
        return view('host.messenger.create', compact('users', 'unreads'));
    }
    ...
    public function storeTopic(QaTopicCreateRequest $request)
    {
        ...
        return redirect()->route('host.messenger.index');
    }
    ...
    public function showMessages(QaTopic $topic)
    {
        ...
        return view('host.messenger.show', compact('topic', 'unreads'));
    }
    ...
    public function showReply(QaTopic $topic)
    {
        ...
        return view('host.messenger.reply', compact('topic', 'unreads'));
    }
