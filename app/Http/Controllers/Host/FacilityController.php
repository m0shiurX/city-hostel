...
class FacilityController extends Controller
{
    public function index()
    {
        ...
        return view('host.facilities.index', compact('facilities'));
    }
    ...
    public function create()
    {
        ...
        return view('host.facilities.create');
    }
    ...
    public function store(StoreFacilityRequest $request)
    {
        ...
        return redirect()->route('host.facilities.index');
    }
    ...
    public function edit(Facility $facility)
    {
        ...
        return view('host.facilities.edit', compact('facility'));
    }
    ...
    public function show(Facility $facility)
    {
        ...
        return view('host.facilities.show', compact('facility'));
    }
