...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("host.hostels.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('built_on') ? 'is-invalid' : '' }}" type="text" name="built_on" id="built_on" value="{{ old('built_on', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_seat') ? 'is-invalid' : '' }}" type="text" name="total_seat" id="total_seat" value="{{ old('total_seat', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('garage_size') ? 'is-invalid' : '' }}" type="text" name="garage_size" id="garage_size" value="{{ old('garage_size', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('amenities') ? 'is-invalid' : '' }}" name="amenities" id="amenities">{!! old('amenities') !!}</textarea>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('host.hostels.storeCKEditorImages') }}', true);
...
<script>
    ...
    url: '{{ route('host.hostels.storeMedia') }}',
    maxFilesize: 1, // MB
