                        ...
                        <div class="tabs-box">
                            <div class="tab-btn-box">
                                <ul class="tab-btns tab-buttons centred clearfix">
                                    ...
                                    {{-- <li class="tab-btn active-btn" data-tab="#tab-2">Searn your hostel</li> --}}
                                </ul>
                            </div>
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="author-info clearfix">
                                        ...
                                        <div class="buy-btn pull-right"><a href="property-details.html">{{ $hostel->total_seat ?? '' }}</a></div>
                                    </div>
                                    <div class="title-text"><h4><a href="property-details.html">{{ $hostel->name ?? '' }}</a></h4></div>
                                    <div class="price-box clearfix">
                                        <div class="price-info pull-left">
                                            <h6>Built on</h6>
                                            <h4>{{ $hostel->built_on ?? '' }}</h4>
                                        </div>
