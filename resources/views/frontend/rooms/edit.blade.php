                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.rooms.update", [$room->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="placement" id="placement" value="{{ old('placement', $room->placement) }}">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Room::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $room->status) === (string) $key ? 'checked' : '' }} required>
