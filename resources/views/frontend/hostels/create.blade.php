                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.hostels.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="built_on" id="built_on" value="{{ old('built_on', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="total_seat" id="total_seat" value="{{ old('total_seat', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="garage_size" id="garage_size" value="{{ old('garage_size', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="amenities" id="amenities">{!! old('amenities') !!}</textarea>
...
<script>
    ...
    url: '{{ route('frontend.hostels.storeMedia') }}',
    maxFilesize: 1, // MB
